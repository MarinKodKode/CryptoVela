...
//    init(showSearch: Bool, searchText: String) {
...
#Preview {
    ...
    @Binding var showSearch = false
    @Binding var searchText = false
    
    DashboardView(showSearch: showSearch, searchText: searchText)
}
